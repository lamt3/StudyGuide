...
public class AlienDictionary {
	...
	static class OrderOfCharacters {
		...
		public void printOrder(String[] words, int alpha) {
	...
	public static void main(String[] args) {
		String[] words = { "caa", "aaa", "aaz" };
		OrderOfCharacters o = new OrderOfCharacters();
		o.printOrder(words, 3);
	}
}
